...
<?php echo $header ?>
				...
				<div class="btn-group">
					<a href="/admin/servers/index?locationid=<?php echo $game['game_id'] ?>"" class="btn btn-default"><span class="glyphicon glyphicon-hdd"></span> Сервера игры</a>
					<a href="/admin/games/edit/delete/<?php echo $game['game_id'] ?>" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Удалить игру</a>
				</div>
